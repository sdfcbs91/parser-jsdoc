...
export const astParseNode = (node: any, text: string, name = ""): any => {
  // 进行函数判断和解析
...
const walkReturnType = (returnType: any, text: string) => {
  ...
  return text.substring(range[0] + 1, range[1]).trim();
};
